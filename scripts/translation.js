const lang = {
    ko: {
        title: "이미지 PDF 변환 - 이미지를 무료로 PDF 변환",
        ...
        versionNotSupported: ["지원하지 않는 브라우저 혹은 버전입니다."],
    ...
    jp: {
        title: "イメージを PDF に変換 - イメージを無料でPDF変換",
