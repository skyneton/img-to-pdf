class Compressor {
    ...
    #init = (file, options) => {
        ...
        if(options.quality >= 1) {
            if(this.#isBlob(file)) {
                ...
                this.#done(file, options, new Blob([file.split(",")[1]], type), type, size, url, createURL);
    ...
    #getBlob(value, type) {
        return new Promise(resolve => {
            ...
            else if(this.#isBase64(value)) resolve(new Blob(value.split(",")[1], {type: type}));
