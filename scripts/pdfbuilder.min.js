...
getPageWidth(){page=arguments[0]|this.#currentPage;return this.#pageContent[page].media.width}
getPageHeight(){page=arguments[0]|this.#currentPage;return this.#pageContent[page].media.height}
