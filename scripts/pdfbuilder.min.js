...
getPageWidth(){const page=arguments[0]|this.#currentPage;return this.#pageContent[page].media.width}
getPageHeight(){const page=arguments[0]|this.#currentPage;return this.#pageContent[page].media.height}
...
if(isNaN(x)||isNaN(y))throw new Error("x, y는 숫자 형태여야 합니다.");return this.#drawImageToPDF(this.#currentPage,imageData,x,y,w,h)}
...
this.#pageContent[page].image.push({hash:index,width:w||this.#imageContent[index].width,height:h||this.#imageContent[index].height,x:x,y:y});return}
